...
router.post("/forgot-password",        resetLimiter, forgotPasswordRules, validate, asyncHandler(AuthController.forgotPassword));
router.post("/reset-password/:token",  resetLimiter, resetPasswordRules,  validate, asyncHandler(AuthController.resetPassword));
...
router.put("/me",          protect, asyncHandler(AuthController.updateProfile));
router.put("/me/password", protect, asyncHandler(AuthController.changePassword));
